...
(:predicates
    ...
    (sensed_craftbowouta ?v0 - material)
    ...
    (sensed_craftbowini ?v0 - material)
    (sensed_craftbowinh ?v0 - material)
...
(:action sensed_craftbow
    :parameters    (?world01 - world ?world02 - world ?material10 - material ?direction01 - direction ?actor01 - actor ?material00 - material ?material01 - material ?material02 - material )
    :precondition  (and
        (sensed_craftbowinb ?material00)
        (sensed_craftbowinc ?material01)
        (sensed_craftbowind ?material00)
        (sensed_craftbowinf ?material01)
        (sensed_craftbowinh ?material00)
        (sensed_craftbowini ?material01)
        (>= ( inventory ?material01) 3)
        (>= ( inventory ?material00) 3)
        (at ?actor01 ?world01)
        (orientation ?actor01 ?direction01)
        (adjacent ?world01 ?world02 ?direction01)
        (at ?material10 ?world02)
        (crafter ?material10)
        (sensed_craftbowouta bow)
    )
    :effect  (and
        (decrease ( inventory ?material01) 3)
        (decrease ( inventory ?material00) 3)
        (increase ( inventory bow) 1)
    )
)
...
(:action extractstring
    :parameters    (?actor01 - actor ?world01 - world ?world02 - world ?world03 - world ?direction01 - direction )
    :precondition  (and
        (at ?actor01 ?world01)
        (orientation ?actor01 ?direction01)
        (at wool ?world02)
    ...
    :effect  (and
        (not (isBlock wool ?world02))
        (not (at wool ?world02))
        (isBlock air ?world02)
        (at air ?world02)
        (increase ( inventory string) 4)
    )
)
